...
const config = {
  ...
  translateConfigDir: "./frontend/src/bt-i18n",
  defaultZhConfig: "./frontend/src/bt-i18n/zh.panel_source.js",
...
async function readZhLangConfig() {
  ...
  try {
    ...
    const langConfig = (await import(path.resolve(config.defaultZhConfig))).default
